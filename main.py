...
image = (
    ...
    .apt_install("git")
    .uv_pip_install("transformers", "diffusers", "pydantic", "torch", "fastapi[standard]")
...
@app.cls(image=image, secrets=[music_gen_secrets], gpu="L40S", volumes={"/models": modal_volume, "/.cache/huggingface": hf_volume}, scaledown_window=15)
class MusicGenServer:
    ...
    @modal.fastapi_endpoint(method="POST")
    def generate_with_description(self) -> GenerateMusicResponse:
        pass
